package com.jornada.dev.eficiente.desafio1.builders.author;
...
public class AuthorBuilder {
    ...
    public static AuthorRequest createAuthorRequest(String name,
                                                    String email,
                                                    String description) {
    ...
    public static AuthorDto createAuthorDto(String name,
                                            String email,
                                            String description) {
    ...
    public static AuthorEntity createAuthorEntity(String name,
                                                  String email,
                                                  String description) {
